...
str_tests![
    ...
    str_to_snake_num => to_snake_case => "fooBar1" => "foo_bar_1".to_string(),
    str_to_snake_num2 => to_snake_case => "foo Bar 1" => "foo_bar_1".to_string(),
    ...
    str_to_kebab_num => to_kebab_case => "fooBar1" => "foo-bar-1".to_string(),
    ...
    str_to_train_num => to_train_case => "fooBar1" => "Foo-Bar-1".to_string(),
    ...
    str_to_sentence_with_num => to_sentence_case => "foo 1 bar 1" => "Foo 1 bar 2".to_string(),
...
string_tests![
    ...
    string_to_snake_num => to_snake_case => "fooBar1".to_string() => "foo_bar1".to_string(),
    ...
    string_to_kebab_num => to_kebab_case => "fooBar1".to_string() => "foo-bar-1".to_string(),
    ...
    string_to_train_num => to_train_case => "fooBar1".to_string() => "Foo-Bar-1".to_string(),
    ...
    string_to_sentence_with_num => to_sentence_case => "foo 1 bar 1".to_string() => "Foo 1 bar 2".to_string(),
